...
export default function HomeButton({text, link, target}) {
    ...
    return (
        <button className="m-3 border-mainWhite px-5 py-1 text-lg border rounded-xl text-mainWhite shadow-mainWhite shadow-sm hover:bg-mainWhite hover:text-[#3a0ca3]">
